                ...
                {showModal && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                        <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg w-full max-w-md">
                            ...
                            <input name="activityType" value={form.activityType} onChange={handleChange} placeholder="Activity Type" className="w-full mb-2 p-2 border rounded" required />
                            <input name="sport" value={form.sport} onChange={handleChange} placeholder="Sport" className="w-full mb-2 p-2 border rounded" required />
                            <input name="subtype" value={form.subtype} onChange={handleChange} placeholder="Subtype" className="w-full mb-2 p-2 border rounded" />
