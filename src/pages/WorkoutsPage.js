...
const WorkoutPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-white to-indigo-50 dark:from-gray-900 dark:to-gray-800 p-4 sm:p-6 text-gray-900 dark:text-white">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 sm:mb-6">
                    <div className="flex flex-col items-center sm:flex-row sm:items-center sm:gap-4 sm:min-w-[50%]">
                    ...
                    <div className="flex flex-col items-center sm:items-end sm:flex-col gap-2 mt-4 sm:mt-0">
                        <button
                            onClick={() => setShowModal(true)}
                            className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-4 py-2 rounded shadow text-sm sm:text-base w-32"
                        >
                            Add Workout
                        </button>
                        <button
                            onClick={() => window.location.href = '/'}
                            className="bg-gray-500 hover:bg-gray-600 text-white font-semibold px-4 py-2 rounded shadow text-sm sm:text-base w-32"
                        >
                            Home
                        </button>
                    </div>
